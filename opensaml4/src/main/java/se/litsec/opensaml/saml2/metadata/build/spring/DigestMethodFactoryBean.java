...
/**
 * A Spring factory bean for {@link DigestMethod} objects.
 * 
...
public class DigestMethodFactoryBean extends AbstractSAMLObjectBuilderFactoryBean<DigestMethod> {
  ...
  /** The builder. */
  private DigestMethodBuilder builder;
  ...
  public DigestMethodFactoryBean(String algorithm) {
    this.builder = DigestMethodBuilder.builder();
    this.builder.algorithm(algorithm);
  }
